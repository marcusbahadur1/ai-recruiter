...
| File | Description |
|---|---|
| [guidelines.md](guidelines.md) | 15 coding rules: multi-tenancy, DB, AI facade, Celery, GDPR, SSE, testing, Pydantic, frontend |
| [spec.md](spec.md) | Full application specification v3.0 — 24 sections covering all features, models, routes, and deployment |
