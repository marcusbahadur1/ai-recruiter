...
_JOB_COLLECTION_SYSTEM = (
    ...
    "hiring_manager_email. Leave optional fields (salary, tech_stack, team_size) as "
    "'Not specified' — do NOT ask for them.\n\n"
    ...
    "Guide through 4 combined steps — one message per step:\n"
    ...
    "Once you have the title, suggest 3-5 title variations.\n"
    "Step 3: Ask in ONE message: city/location, work type (onsite/hybrid/remote/"
    "remote_global), salary range (optional).\n"
    "Step 4: Ask in ONE message: hiring manager name + email, minimum suitability "
    "score (default 6 out of 10), candidate target count (default 20).\n"
    "After step 4 response, output the full Job Summary block (RULE C).\n\n"
