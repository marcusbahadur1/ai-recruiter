...
_JOB_COLLECTION_SYSTEM = (
    ...
    "A pasted JD is typically long (>80 words) and contains structured sections "
    "(responsibilities, requirements, about the role, etc.).\n"
    ...
    "A conversational message is short or casual (e.g. 'I need to hire a Python developer in Sydney').\n"
    "Extract any details already mentioned into job_fields. "
    "Then set message to a friendly question asking for the most important MISSING fields.\n"
    "Ask 2-3 questions per turn. Priority order: required_skills → experience_years → work_type "
    "(onsite/hybrid/remote) → salary range → hiring manager details.\n"
    "Do NOT set message to '' and do NOT set ready_for_payment=true until the recruiter has "
    "provided at minimum: title, location, required_skills, and work_type.\n\n"
